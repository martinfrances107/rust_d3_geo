...
// fn fit<DRAIN, L, PR, PV, T>(
//     builder: Builder<DRAIN, L, PR, PV, T>,
//     fit_bounds: Box<
//         dyn FnOnce(
//             [Coordinate<T>; 2],
...
// pub fn fit_extent<DRAIN, L, PR, PV, T>(
//     builder: Builder<DRAIN, L, PR, PV, T>,
...
//         builder,
//         Box::new(
//             move |b: [Coordinate<T>; 2], builder: Builder<DRAIN, L, PR, PV, T>| {
