mod distance_test {
  ...
  fn great_arc() {
    ...
    assert_eq!(distance(&Point{x:0f64, y:0f64}, &Point{x:0f64, y:0f64}), 0f64);
    assert!(in_delta(
      distance(
        &Point{x:118f64 + 24f64 / 60f64, y:33f64 + 57f64 / 60f64},
        &Point{x:73f64 + 47f64 / 60f64, y:40f64 + 38f64 / 60f64}
      ),
      3974f64 / 6371f64,
      0.5f64
    ));
