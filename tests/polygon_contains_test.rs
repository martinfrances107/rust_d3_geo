...
fn small_circle() {
  ...
  println!("polygon form circle {:?}", polygon);
...
fn large_narrow_equatorial_hole() {
  println!("geoPolygonContains(empty, point) returns false");
  let mut circle1 = Circle::new(None, None, None);
  circle1.center(&[0f64, -90f64]);
  circle1.radius(90f64 - 0.1f64);
...
fn ring_near_origin() {
  ...
  let ring0 = vec![[0f64, 0f64], [0f64, 1f64], [1f64, 1f64], [1f64, 0f64], [0f64, 0f64]];
  let ring1 = vec![[0.4f64, 0.4f64], [0.6f64, 0.4f64], [0.6f64, 0.6f64], [0.4f64, 0.6f64], [0.4f64, 0.4f64]];
...
fn ring_equatorial() {
  ...
  let ring0 = vec![[0f64, -10f64], [-120f64, -10f64], [120f64, -10f64],  [0f64, -10f64]];
  let ring1 = vec![[0f64, 10f64], [120f64, 10f64], [-120f64, 10f64], [0f64, 10f64]];
  let polygon = vec![ring0, ring1];
...
fn ring_excluding_both_poles() {
  ...
  let mut ring0 = vec![[10f64, 10f64], [-10f64, 10f64], [-10f64, -10f64], [10f64, -10f64], [10f64, 10f64]];
  ring0.reverse();
  let mut ring1 = vec![[170f64, 10f64], [170f64, -10f64], [-170f64, -10f64], [-170f64, 10f64], [170f64, 10f64]];
  ring1.reverse();
  let polygon = vec![ring0, ring1];
...
fn ring_containing_both_poles() {
  println!("geoPolygonContains(ringExcludingBothPoles, point) returns the expected value");
  let ring0 = vec![[10f64, 10f64], [-10f64, 10f64], [-10f64, -10f64], [10f64, -10f64], [10f64, 10f64]];
  let ring1 = vec![[170f64, 10f64], [170f64, -10f64], [-170f64, -10f64], [-170f64, 10f64], [170f64, 10f64]];
  let polygon = vec![ring0, ring1];
...
fn ring_containing_south_pole() {
  ...
  let ring0 = vec![[10f64, 10f64], [-10f64, 10f64], [-10f64, -10f64], [10f64, -10f64], [10f64, 10f64]];
  let ring1 = vec![[0f64, 80f64], [120f64, 80f64], [-120f64, 80f64], [0f64, 80f64]];
  let polygon = vec![ring0, ring1];
...
fn ring_containing_north_pole() {
  ...
  let mut ring0 = vec![[10f64, 10f64], [-10f64, 10f64], [-10f64, -10f64], [10f64, -10f64], [10f64, 10f64]];
  ring0.reverse();
  let mut ring1 = vec![[0f64, 80f64], [120f64, 80f64], [-120f64, 80f64], [0f64, 80f64]];
  ring1.reverse();
  let polygon = vec![ring0, ring1];
...
fn self_intersecting_near_origin() {
  ...
  let polygon = vec![vec![[0f64, 0f64], [1f64, 0f64], [1f64, 3f64], [3f64, 3f64], [3f64, 1f64], [0f64, 1f64], [0f64, 0f64]]];
...
fn self_intersecting_near_south_pole() {
  ...
  let polygon = vec![vec![[-10f64, -80f64], [120f64, -80f64], [-120f64, -80f64], [10f64, -85f64], [10f64, -75f64], [-10f64, 75f64], [-10f64, -80f64]]];
  assert_eq!(polygon_contains(&polygon, &[0f64, 0f64]), false);
...
fn self_intersecting_near_north_pole() {
  ...
  let polygon = vec![vec![[-10f64, 80f64], [-10f64, 75f64], [10f64, 75f64], [10f64, 85f64], [-120f64, 80f64], [120f64, 80f64], [-10f64, 80f64]]];
  assert_eq!(polygon_contains(&polygon, &[0f64, 0f64]), false);
  assert_eq!(polygon_contains(&polygon, &[0f64, 76f64]), true);
  assert_eq!(polygon_contains(&polygon, &[0f64, 89f64]), true);
}
...
fn triangle_touching_the_south_pole() {
  ...
  let polygon = vec![vec![[180f64, -90f64], [-45f64, 0f64], [45f64, 0f64], [180f64, -90f64]]];
...
fn triangle_touching_the_south_pole2() {
  ...
  let polygon = vec![vec![[-45f64, 0f64], [45f64, 0f64], [180f64, -90f64], [-45f64, 0f64]]];
  assert_eq!(polygon_contains(&polygon, &[-46f64, 0f64]), false);
  assert_eq!(polygon_contains(&polygon, &[0f64, 1f64]), false);
  assert_eq!(polygon_contains(&polygon, &[-90f64, -80f64]), false);
  assert_eq!(polygon_contains(&polygon, &[-44f64, 0f64]), true);
...
fn triangle_touching_the_south_pole3() {
  println!("geoPolygonContains(triangleTouchingTheSouthPole2, point) returns the expected value");
  let polygon = vec![vec![[180f64, -90f64], [-135f64, 0f64], [135f64, 0f64], [180f64, -90f64]]];
