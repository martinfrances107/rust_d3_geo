...
//     use rust_d3_geo::projection::azimuthalEqualArea::AzimuthalEqualAreaRaw;
...
//             Some(p) => match p {
//                 PathResultEnum::Path(p) => {
//                     println!("Path {:?}", p);
//                     panic!();
//                 }
//                 PathResultEnum::ClipBufferOutput(x) => {
//                     println!("ClipBufferOut is not a path {:#?}", x);
//                     panic!("fail");
//                 }
//                 PathResultEnum::Sring(x) => {
//                     println!("string is not a path {:#?}", x);
//                     panic!("fail");
//                 }

//                 PathResultEnum::Area(x) => {
//                     println!("area is not a path {:#?}", x);
//                     panic!("fail");
//                 }

//                 PathResultEnum::Measure(x) => {
//                     println!("Measue is not a path {:#?}", x);
//                     panic!("fail");
//                 }
//                 PathResultEnum::Bound(x) => {
//                     println!("Bound is not a path {:#?}", x);
//                     panic!("fail");
//                 }

//                 PathResultEnum::Centroid(x) => {
//                     println!("Centroid is not a path {:#?}", x);
//                     panic!("fail");
//                 }
//             },
//             None => {
