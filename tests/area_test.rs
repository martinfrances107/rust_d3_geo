...
//     #[inline]
//     fn equirectangular<'a, T: CoordFloat + FloatConst + Default>() -> ProjectionMutator<T> {
...
//     #[inline]
//     fn test_area<'a, T>(projection: Option<ProjectionMutator<T>>, object: &DataObject<T>) -> T
//     where
//         T: CoordFloat + FloatConst + Display + AddAssign + Default,
//     {
//         match Path::projection(projection).area(object) {
//             Some(p) => match p {
