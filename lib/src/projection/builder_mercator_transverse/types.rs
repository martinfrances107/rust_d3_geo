...
pub type BuilderMercatorTransverseAntimeridianResampleClip<DRAIN, PR, T> =
    Builder<
...
pub type BuilderMercatorTransverseAntimeridianResampleNoneClip<DRAIN, PR, T> =
    Builder<
...
pub type BuilderMercatorTransverseCircleResampleNoneClip<DRAIN, PR, T> =
    Builder<
