...
// >
// where
// 	I: Interpolator<EP = Bounds<T>, Stream = ResampleClipC<Bounds<T>, PR, T>, T = T>,
// 	LB: LineConnected<SC = Buffer<T>> + Stream<EP = Buffer<T>, T = T>,
// 	LC: LineConnected<SC = ResampleClipC<Bounds<T>, PR, T>> + Stream<EP = Bounds<T>, T = T>,
...
// 			let builder = builder.clip_extent(&clip);
// 		}
// 		None => {}
// 	};
...
// // pub(super) fn fit_extent<I, LB, LC, LU, PR, PV, RCIn, RUIn, RCOut, RUOut, T>(
// // 	builder: Builder<
// // 		Bounds<T>,
// // 		I,
// // 		LB,
