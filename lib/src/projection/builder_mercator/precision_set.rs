...
impl<DRAIN, PR, PCNC, PCNU, T> PrecisionSet
	for Builder<
		...
		LineAntimeridian<
			None<PR, PCNC, PCNU, Connected<PCNC>, T>,
			Connected<None<PR, PCNC, PCNU, Connected<PCNC>, T>>,
			T,
		>,
		LineAntimeridian<None<PR, PCNC, PCNU, Connected<PCNC>, T>, Unconnected, T>,
		PCNC,
		PCNU,
		PR,
		PVAntimeridian<T>,
		None<PR, PCNC, PCNU, Connected<PCNC>, T>,
		None<PR, PCNC, PCNU, Unconnected, T>,
		T,
	> where
...
impl<DRAIN, PR, PCNC, PCNU, T> PrecisionSet
	for Builder<
		...
		LineCircle<
			...
			T,
		>,
		LineCircle<None<PR, PCNC, PCNU, Connected<PCNC>, T>, Unconnected, T>,
		PCNC,
		PCNU,
		PR,
		PVCircle<T>,
