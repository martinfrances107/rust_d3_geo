...
// pub(super) fn fit_rectangle<I, B, Bint, LB, LC, LU, PR, PV, RC, RU, T>(
// 	builder: B,
// 	fit_bounds: FitBounds<Bint, T>,
// 	object: &impl Streamable<T = T>,
// ) -> B
// where
// 	B: ClipExtentBounded<OutputClear = Bint, T = T> + ScaleAdjust<T = T> + TranslateSet<T = T>,
...
// 	fit_rectangle(
// 		builder,
// 		Box::new(|b: [Coordinate<T>; 2], builder: Bint| -> B {
