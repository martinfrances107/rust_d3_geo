...
// impl<T> Clone for RectangleMT<T>
// where
//     T: 'static + CoordFloat,
// {
//     #[inline]
...
// impl<STATE, T> Debug for Rectangle<T>
// where
//     STATE: Debug,
//     T: CoordFloat,
// {
...
// impl<T> StreamMT<T> for RectangleMT<T>
// where
...
//                                         .flatten()
//                                         .collect::<Vec<Vec<LineElem<T>>>>();
//                                     let num_visible_elements =
//                                         merged_segments.len();

//                                     let visible =
//                                         !num_visible_elements.is_zero();
...
//                                 Ok(())
//                             }
//                             Message::EndPoint(_) => tx.send(message),
//                         };
//                         match res_tx {
//                             Ok(()) => {
//                                 continue;
