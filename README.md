...
There is an aspect of the design that needs review. It related to the best way to implement a doubly-linked list which has cross links between nodes. A fully discusion can be found [here](/intersection_problem.rs)
