...
//     let ortho = ortho_builder.rotate(&[45_f64, -90_f64, 0_f64]).build();
...
//                         for p in &mp.0 {
//                             console_log!("mp : poly..");
//                             let res = builder.object(&Geometry::Polygon(p.clone()));
//                             match res {
//                                 Some(res) => match res {
//                                     ResultEnum::String(s) => {
//                                         if s == "EMPTY" {
...
//                                         i = (i + 1) % 6;
//                                     }
//                                     _ => console_log!("Did not decode a string."),
//                                 },
//                                 None => {
//                                     // PathString returned an empty string.
//                                     // Path is not visible!
//                                     drop_count += 1;
//                                     console_log!("dropcount = {}", drop_count);
//                                     console_log!("Droping result(mp).");
//                                 }
//                             }
//                         }
//                     }
...
//                             None => {
//                                 drop_count += 1;
//                                 console_log!("(p) dropcount = {}", drop_count);
//                                 console_log!("Droping result(p).");
//                             }
//                         }
//                     }
//                     _ => {
//                         console_log!("unknown geometry");
//                     }
//                 }
//             }
//         }
